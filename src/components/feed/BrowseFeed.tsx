      ...
      <div className="flex flex-col md:grid md:grid-cols-12 gap-3 w-full">
        ...
        <div className="w-full md:col-span-8 flex">
          {activeChallenge ? (() => {
            ...
            return (
              <div className="w-full bg-[#E5D3C3] border-4 border-[#785942] rounded-lg p-2 md:p-3 shadow-hard relative flex gap-2 sm:gap-3 min-h-[200px] bg-[radial-gradient(#cbb09c_2px,transparent_2px)] [background-size:16px_16px]">
                {/* Pinned Sticky Note */}
                <div className={`flex-1 flex flex-col justify-between p-3 md:p-4 shadow-md border border-black/10 rotate-[-1.5deg] relative transition-transform hover:rotate-0 duration-200 ${style.bg}`}>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <h2 className="font-display font-black text-xs md:text-base lg:text-lg text-primary tracking-tight leading-tight mt-1.5">
                      {activeChallenge.title}
                    </h2>
                    <p className={`text-[9px] md:text-xs font-bold leading-snug mt-1 ${style.text}`}>
                      {activeChallenge.description}
                    </p>
                  </div>
                  
                  <div className="flex items-center justify-between gap-2 shrink-0 pt-1.5 border-t border-black/10 border-dashed mt-2">
                ...
                {polaroidUrl && (
                  <div className="flex flex-col bg-white border border-black/10 p-1 md:p-1.5 pb-2 md:pb-3 shadow-md rotate-[3deg] hover:rotate-0 duration-200 transition-transform w-[120px] md:w-[150px] shrink-0 z-10 self-start">
                    ...
                    <div className="w-full relative bg-black border border-black/5" style={{ aspectRatio: '1 / 1' }}>
